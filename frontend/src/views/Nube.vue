<template>
    <div id="nube">
        ...
        <div style="max-width: 900px; margin: 0 auto">
            ...
            <v-text-field :rules="[field_not_empty]" v-model="SP_10.id_partida" placeholder="Nombre de la Partida" outlined></v-text-field>
        ...
        <div style="max-width: 900px; margin: 0 auto">
            <v-text-field :rules="[field_not_empty]" v-model="DP_11.id_partida" placeholder="Nombre de la Partida" outlined></v-text-field>
        </div>
        ...
        <div style="max-width: 900px; margin: 0 auto">
            ...
            <v-text-field :rules="[field_not_empty]" v-model="CP_12.id_partida" placeholder="Nombre de la Partida" outlined></v-text-field>
        </div>
...
export default {
  ...
  methods: {
    ...
    async DescargarPartida(){
      ...
      try{
        await axios.put(`${url}/api/nube/${this.DP_11.id_partida}`, this.DP_11)
        this.success.DP_11 = true
      } catch (err) {
